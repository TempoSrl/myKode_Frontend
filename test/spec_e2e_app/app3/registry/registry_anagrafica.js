(function() {
    ...
    function metaPage_registry() {
        ...
        // Se controlli a db la riga pèeffettivamente cancellata.
        ...
        // principale, automaticmaente lui fa la save a db, apre la form errori ignorabili
        // Se lo fai su una riga di quelle esistnti, dà un errore non ignorabile, quindi devi premere non salvare. Lui inserisce la riga
        // graficamente, ma se cambi selezione, dàilpopup, ci sono modifiche, premo ok perdi loemod, la riga sulla griglia sparisce.
        ...
        // 9.0 caso non lista entra su EditNewCopy. Devi scommentare la parte sulla activation che per debug fa la fill de ds. e togli
        ...
        // -> "premo salva" sulla toolbar ricevo 1 msg ignorabile, e salvo -> adbritrovo la riga con il campo editato

        // 9.1 Caso  lista: metti dall'AfterLink la setList()
        // Premi "Inserici copia" -> apre il dettaglio per editare, e cambaire alcuni parametri. peremi mainsave, trona al padre e salva.
        // -> A DB appsre il record. fai doppio click
        // doppio click sulla riga creata, cambia annotatione  premi mani save, la griglia mostra nuovo valore, "Salva"
        // ignora e salva-> a db viene salavatola modifica
        ...
        switch (appMeta.testCaseNumber){
            case 1:
                this.startFilter = q.or(q.eq('idreg',1) , q.eq('idreg',2), q.eq('idreg',6), q.eq('idreg',1040471));
                break;
            case 7:
                break;
