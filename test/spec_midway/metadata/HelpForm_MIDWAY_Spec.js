            ...
            function() {
                    ...
                    function() {
                        ...
                        it("INPUT TEXT - Enter/Leave events - DATETIME",
                            function(done) {
                                ...
                                helpForm.preScanControls();
                                helpForm.fillControls() // per robustezza del test faccio anche la fillControls()
                                    .then(function() {
                                        $("#txtBox1")
                                            .val(
                        ...
                        xit("SELECT - Change Event case 1",
                            function(done) {
                                var mainwin = '<div id="rootelement">' +
                                ...
                                helpForm.fillControls()
                                    .then(function() {
                                        ...
                                        // TEST CHECKBOX
                                        expect($("#mycheck1").is(":checked"))
                                            .toBe(
                                                true); // la riga objrow7 ha maschio su c_sex ,che corrisponde al valore selzionato
                                        // TEST RADIO
                                        ...
                                        var s = stabilize();
                                        $("#combo1").val("4")
                                            .change(); // **** simulo la selezione del valore "4" - corrisponde ad objrow8 ***
                                        return s;
                                    })
                                    .then(function() {
                            ...
                            function(done) {
                                ...
                                helpForm.fillControls()
                                    .then(function() {
                                        ...
                                        var s = stabilize();
                                        $("#combo3").val("4").change(); // **** simulo la selezione del valore "4" - corrisponde ad objrow8 ***
                                        return s;
                                    })
                                    .then(function() {
                                        expect($("#combo3").val()).toBe("4");
                                        expect($("#combo3>option:selected").html()).toBe("quattro");
                                        expect($("#combo4>option:selected").html()).toBe("f2_3");
                                        done();
                                    });
                        ...
                        it("SELECT - Change Event 4. Grid + Combo, UNCHANGED state of rows",
                            function(done) {
                                ...
                                stabilize(true).then(function() {
                                        ...
                                        expect($("#combo3").html())
                                            .toBe(
                                                '<option value=""></option><option value="4">quattro</option><option value="3">tre</option><option value="1" data-select2-id="13">uno</option>');
                                        var res = stabilize();
                ...
                describe("Add custom Events on standard button",
                    function() {
                        ...
                        xit('AutoChoose attaches events on textbox, with mock of function choose() on MetaPage',
                            function(done) {
