/*globals ObjectRow,DataRelation,define,self,jsDataSet,jsDataQuery,sqlFun,_ */
	...
	function(jsDataSet, jsDataQuery, _){
		...
		MetaModel.prototype = {
				...
				_.forEach(dRow.table.columns,
					function (c){
						try{
							...
							// console.log(e);
							// console.log("comparing ", c, dRow[c]," of table ",dRow.table.name);
							throw e;
						}
					});
			...
			applyCascadeDelete: function (rowToDelete){
				//return rowToDelete.getRow().table.dataset.cascadeDelete(rowToDelete);
